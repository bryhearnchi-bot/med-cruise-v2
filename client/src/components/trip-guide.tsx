  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-ocean-600 via-ocean-500 to-ocean-400">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-ocean-600 via-ocean-500 to-ocean-400">
        {/* Hero Section */}
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center text-center">
            <div className="max-w-4xl px-4">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-2 drop-shadow">
        ...
        {/* Content Area with top padding to account for fixed banner */}
        <div className="pt-80">
          {/* Daily Schedule Tab */}
