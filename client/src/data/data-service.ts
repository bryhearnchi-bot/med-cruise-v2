...
import { ITINERARY, TALENT, DAILY, PARTY_THEMES, CITY_ATTRACTIONS } from './cruise-data';
import { MOCK_ITINERARY, MOCK_TALENT, MOCK_DAILY, MOCK_PARTY_THEMES, MOCK_CITY_ATTRACTIONS } from './mock-data';

const isProduction = import.meta.env.NODE_ENV === 'production';
const useMockData = import.meta.env.VITE_USE_MOCK_DATA === 'true';

// In production, always use real Greek cruise data
...
// Get the appropriate cruise slug based on environment
export const getCruiseSlug = () => {
  return shouldUseMockData ? 'mock-cruise-2024' : 'greek-isles-2025';
};
